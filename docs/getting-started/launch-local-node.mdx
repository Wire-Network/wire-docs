...
Once local development environment is set up, you can progress to [Smart Contracts Development: Hello World](/docs/smart-contract-development/hello-world-contract) where you will build and deploy your first contract.
:::
