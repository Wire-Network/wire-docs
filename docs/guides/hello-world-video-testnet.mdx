...
- **Open [Wire Hub](https://explore.wire.foundation)** in your browser.  
- **Connect your wallet** (e.g., MetaMask).  
   - Once connected, the Hub should display your account’s public address.  
- **Create your on-chain account** in the [Wire Testnet Explorer](https://explore.wire.foundation//explore):  
...
- **Open the [Node Owner Dashboard](https://explore.wire.foundation//explore/node-owner)**.  
...
- Confirm the new contract policy was created. In the [Wire Hub](https://explore.wire.foundation) or [Explorer](https://explore.wire.foundation//explore), you should see:
...
- In the [Wire Hub](https://explore.wire.foundation) or [Explorer](https://explore.wire.foundation//explore), navigate to the *Accounts* -> *Contract Accounts* list. You should see your new contract.
...
- In the [Wire Hub](https://explore.wire.foundation), open the *Contract* Tab for your contract’s account.
