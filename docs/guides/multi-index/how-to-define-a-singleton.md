...
* A Wire development environment, for details consult the [Getting Starter guide](/docs/getting-started/getting-started-intro.md),
...
:::info
| A full example project demonstrating the instantiation and usage of singleton can be found in the [`multi_index example` project](https://github.com/Wire-Network/cdt/blob/main/examples/multi_index_example).
:::
...
* The [`singleton` class](https://github.com/Wire-Network/wire-cdt/blob/a0628aa6e947e8b4a83cde1b074e0cfa9f522369/libraries/sysiolib/contracts/sysio/singleton.hpp#L21).
