...
* [cleos create key](../command-reference/create/key.md) command
* [cleos wallet import](../command-reference/wallet/import.md) command
* [cleos set account](../command-reference/set/set-account.md) command
