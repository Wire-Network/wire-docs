...
* Familiarize with the [`cleos get block`](../command-reference/get/block.md) command and its parameters.
...
* Understand the [block lifecycle](http://example.com) in the EOSIO consensus protocol.
