...
`cleos` is distributed as part of the [Wire software suite](https://github.com/siliconswampio/wire-eosio/blob/master/README.md). To install `cleos` just visit the [Install Dependemcies](/docs/getting-started/install-dependencies.md) section.
