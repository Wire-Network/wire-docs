...
```sh
clio system unregprod <account> [OPTIONS]
```
...
```sh
clio system unregprod
  <account>                          # REQUIRED: The account to unregister as a producer
...
The following examples demonstrate how to use the `clio system unregprod` command:

### Unregister a producer

```sh
clio system unregprod alice -p alice@active
```
