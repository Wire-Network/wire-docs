...
* Maintainable resource commitments at the SYSIO nodes
...
Here is a `nodeop` configuration example for the `trace_api_plugin` when tracing some SYSIO reference contracts:
