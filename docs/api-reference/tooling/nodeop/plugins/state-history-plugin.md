...
* [How to fast start without previous history](/docs/guides/nodeop/how-to-fast-start-without-old-history.md)
* [How to create a portable snapshot with full state history](/docs/guides/nodeop/how-to-create-snapshot-with-full-history.md)
* [How to restore from portable snapshot with full state history](/docs/guides/nodeop/how-to-restore-snapshot-with-full-history.md)
