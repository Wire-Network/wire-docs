...
* The [`hello`](https://github.com/Wire-Network/cdt/blob/develop/examples/hello/src/hello.cpp#L14) smart contract example, see action `hello::checkwithrv`.
* The [How-to return values from actions](../how-to-guides/how-to-return-values-from-actions.md).
